...
function usage(): string {
    return [
        'Usage:',
        '  npm run cli -- plan "<task>" [--provider openai|gemini|claude] [--screenshot] [--showLlm]',
        '  npm run cli -- run  "<task>" [--provider openai|gemini|claude] [--screenshot] [--showLlm] [--record]',
        '  npm run cli -- loop "<task>" [--provider openai|gemini|claude] [--maxIterations N] [--no-verify] [--no-perception] [--showLlm] [--record]',
        '  npm run cli -- replay "<recordingFile>" [--no-robust]',
        '  npm run cli -- match "<task>" [--limit N] [--threshold S]',
        '  npm run cli -- auto "<task>" [--provider openai|gemini|claude] [--threshold S] [--maxIterations N] [--no-verify] [--no-perception] [--showLlm] [--no-robust] [--no-record]',
        '',
        'Environment:',
        '  LLM_PROVIDER=openai|gemini|claude (optional, default openai)',
        ...
        '  ANTHROPIC_API_KEY (required for Claude plan/run/loop/auto)',
